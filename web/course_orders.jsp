        ...
        fetch('/admin/api/order-detail?id=' + orderId)
            ...
            .then(data => {
                let content = `
                    ...
                    <p><strong>课程名:</strong> ${data.course_name}</p>
                    <p><strong>用户名:</strong> ${data.username}</p>
                    <p><strong>支付方式:</strong> ${data.pay_method}</p>
                    <p><strong>支付状态:</strong> ${data.status}</p>
                    <p><strong>下单时间:</strong> ${data.created_at}</p>
                    <p><strong>支付时间:</strong> ${data.paid_at || '-'}</p>
